...
if (document.getElementById('contasturbo_plugin') == null) {
	...
	document.body.innerHTML = '\
		...
		<div id="contasturbo_plugin" style="width:100%; height:70px;">\
			<iframe style="position: absulute; z-index: 99999; width: 100%; min-width: 950px;" scrolling="no" src="http://api.contasturbo.com/plugin/header.php" frameBorder="0"></iframe>\
		</div>\
	' + document.body.innerHTML;
